...
public class TaskController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Get task by IDsssss", description = "Retrieves a specific task by its ID")
    public ResponseEntity<Task> getTaskById(@PathVariable Long id) {
        return ResponseEntity.ok(taskService.getTaskById(id));
    }

    @PostMapping
    @Operation(summary = "Create new task test", description = "Creates a new task")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Delete tasks", description = "Deletes a task by its ID")
